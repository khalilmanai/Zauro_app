...
let AuthController = class AuthController {
    ...
    async forgotPasswordRequest(forgotPasswordDto) {
    ...
    async resetPassword(resetPasswordDto) {
        return this.authService.resetPassword(resetPasswordDto.code, resetPasswordDto.newPassword, resetPasswordDto.email, resetPasswordDto.phone);
    }
